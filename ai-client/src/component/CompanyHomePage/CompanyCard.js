                ...
                <div className="">
                    <div className="container">
                        <div className="title-image">
                            <img className="img-fluid" src={res.url || "https://q2w6m4y3.stackpathcdn.com/media/catalog/product/cache/1/image/320x320/9df78eab33525d08d6e5fb8d27136e95/j/u/juspay-payment-gateway-320x320_1.png"} alt="" />
                        </div>
                        <div className="desc">
                            <div className="title">
